...
// Normalizes a title for cross-source duplicate detection — e.g. "MacDowell Artist Residency"
// found by the daily program-page re-check and "MacDowell Artist Residency " (trailing space,
// different capitalization) found by AI discovery a week later should be treated as the SAME
// opportunity, even though they come from different `source` values.
...
module.exports = { isValid, looksFeeFree, isDeepLink, isFutureDate, normalizeTitle };
